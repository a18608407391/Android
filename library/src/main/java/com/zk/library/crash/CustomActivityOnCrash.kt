...
object CustomActivityOnCrash {
    ...
    private val TAG = "CustomActivityOnCrash"

    //Extras passed to the error activity
    private val EXTRA_CONFIG = "cat.ereza.customactivityoncrash.EXTRA_CONFIG"
    private val EXTRA_STACK_TRACE = "cat.ereza.customactivityoncrash.EXTRA_STACK_TRACE"
    private val EXTRA_ACTIVITY_LOG = "cat.ereza.customactivityoncrash.EXTRA_ACTIVITY_LOG"

    //General constants
    private val INTENT_ACTION_ERROR_ACTIVITY = "cat.ereza.customactivityoncrash.ERROR"
    private val INTENT_ACTION_RESTART_ACTIVITY = "cat.ereza.customactivityoncrash.RESTART"
    private val CAOC_HANDLER_PACKAGE_NAME = "cat.ereza.customactivityoncrash"
     ...
     */
    private fun isStackTraceLikelyConflictive(h: Throwable, activityClass: Class<out Activity>): Boolean {
        var th = h
        do {
        ...
        } while ((th.cause!!.also { it -> th = it }) != null)
        return false
    }
