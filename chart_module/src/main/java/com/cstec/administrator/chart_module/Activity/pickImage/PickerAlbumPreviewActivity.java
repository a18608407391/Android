...
import com.cstec.administrator.chart_module.Utils.ImageUtil;
...
public class PickerAlbumPreviewActivity extends UIView implements OnClickListener, OnPageChangeListener {
    ...
    private void initActionBar() {
        previewSelectBtn = (ImageView) findViewById(R.id.right_img);
    ...
    public void setImageView(PhotoInfo info) {
        ...
        if (bitmap == null) {
            ...
            Log.e("result","PickerAlbumPreviewActivity");
