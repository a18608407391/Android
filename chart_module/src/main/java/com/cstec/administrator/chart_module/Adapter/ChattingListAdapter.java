...
//                        intent.putExtra(BaseApplication.Companion.getTARGET_APP_KEY(), userInfo.getAppKey());
//                        intent.putExtra(BaseApplication.Companion.getGROUP_ID(), mGroupId);
//                        if (userInfo.isFriend()) {
...
//                                BaseApplication.Companion.getREQUEST_CODE_FRIEND_INFO());
//                    }
                }
            });
