...
class ConversationFragmentListAdapter(private val mContext: Activity, private val mDatas: MutableList<Conversation>?, private val mConversationListView: MessageFragment) : BaseAdapter() {
...
//                })
    ...
    private class UIHandler(adapter: ConversationFragmentListAdapter) : Handler() {

        private val mAdapter: WeakReference<ConversationFragmentListAdapter>
