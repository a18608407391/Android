package com.elder.zcommonmodule.Service.Screen;
...
public class ScreenRecordService extends Service implements Handler.Callback {
    ...
    private int mRecordWidth = UtilsKt.getWindowWidth();
    private int mRecordHeight = UtilsKt.getWindowHight();
    private int mScreenDpi = UtilsKt.getDpi();
    ...
    public boolean startRecord() {
        ...
        if (mMediaProjection == null) {
            Log.e("result", "mMediaProjection为Null");
        }
        if (mMediaRecorder == null) {
            Log.e("result", "mMediaRecorder为Null");
        }
...
//        mRecordFilePath = null;
    ...
    public void setFilePath(String id) {
        mRecordFilePath = getSaveDirectory() + File.separator + id + ".mp4";
    }

    public boolean queryPath(String id) {
        File f = new File(getSaveDirectory() + File.separator + id + ".mp4");
        return f.exists();
    }
