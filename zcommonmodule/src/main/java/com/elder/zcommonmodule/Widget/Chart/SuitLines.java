...
package com.elder.zcommonmodule.Widget.Chart;
...
public class SuitLines extends View {
    ...
    private void initOptionalState(Context ctx, AttributeSet attrs) {
        TypedArray ta = ctx.obtainStyledAttributes(R.styleable.suitlines);
     ...
     */
    private int[] defaultLineColor = {Color.parseColor("#62B297"), Color.parseColor("#62B297"), Color.parseColor("#62B297")};
