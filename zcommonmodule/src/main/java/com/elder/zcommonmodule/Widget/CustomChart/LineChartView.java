        ...
        for (int i = begin; i < end; i++) {
            ...
            if (dot.isVisible()) {
                ...
                if (i == index) {
                    ...
                    labelsPaint.setTextSize(ConvertUtils.Companion.dp2px(8F));
                    float f = labelsPaint.measureText(dot.getValue() + "km");
                    //位置判断

                    if (dot.getValue() == 0.1F) {
                        canvas.drawText(0 + "km", ConvertUtils.Companion.dp2px(35)-f/2, ConvertUtils.Companion.dp2px(20), labelsPaint);
                    }else{
                        canvas.drawText(new DecimalFormat("0.00").format(dot.getValue()) + "km", ConvertUtils.Companion.dp2px(35)-f/2, ConvertUtils.Companion.dp2px(20), labelsPaint);
                    }


//                    if (index == begin) {
//                        //判断右边的点Y轴差距
//                        Float NextY = set.getEntries().get(index + 1).getY();
//                        if (dot.getY() - NextY <= 0) {
//                            //持平或者往下走的.
//                            canvas.drawText(dot.getValue() + "km", dot.getX(), dot.getY() + ConvertUtils.Companion.dp2px(15F), labelsPaint);
//                        } else {
//                            //往上走的
//                            canvas.drawText(dot.getValue() + "km", dot.getX()+x/2, dot.getY() - ConvertUtils.Companion.dp2px(15F), labelsPaint);
//                        }
//                    } else if (index == end - 1) {
//                        Float LastY = set.getEntries().get(index - 1).getY();
//                        if (dot.getY() - LastY <= 0) {
//                            //往下走的
//                            canvas.drawText(dot.getValue() + "km", dot.getX() - x, dot.getY() - ConvertUtils.Companion.dp2px(15F), labelsPaint);
//                        } else {
//
//                            canvas.drawText(dot.getValue() + "km", dot.getX() + x, dot.getY() + ConvertUtils.Companion.dp2px(15F), labelsPaint);
//                        }
...
//                        if (dot.getY() <= 100) {
//                            //顶部位置
//                            if (NextY > LastY && LastY > dot.getY()) {
//                                //驼峰
//
//                            } else if (NextY > LastY && LastY < dot.getY()) {
//
//                            } else if (NextY < LastY && LastY < dot.getY()) {
//                                //凹面
//                            } else if (NextY < LastY && LastY > dot.getY()) {
//
//                            }
//                        } else if (dot.getY() >= 100 && dot.getY() < 200) {
//                             //中部位置
//
//                        } else {
//                            //底部位置
...
//
//
////                        canvas.drawText(dot.getValue() + "km", dot.getX() - x / 2, dot.getY() + ConvertUtils.Companion.dp2px(30F), labelsPaint);
//                    }

//                    if (dot.getX() < x / 2) {
//                        最左边
//                    } else if (dot.getX() > UtilsKt.getWindowWidth() - x / 2) {
//                        最右边
//                    }else if(){
//
//                    }
