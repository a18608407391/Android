        ...
        if (!view.isCheck.get()!!) {
            ...
            if (index == 0) {
                if (driverViewModel != null) {
                    if (driverViewModel?.mapActivity!!.mViewModel?.currentPosition == 0) {

                    } else if (driverViewModel?.mapActivity!!.mViewModel?.currentPosition == 3) {
...
//        }
        ...
        if (driverViewModel != null) {
            if (driverViewModel?.mapActivity?.mViewModel?.currentPosition == 3) {
