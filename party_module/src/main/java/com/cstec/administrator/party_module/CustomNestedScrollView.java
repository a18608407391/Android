...
public class CustomNestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            if (super.performAccessibilityAction(host, action, arguments)) {
                ...
                CustomNestedScrollView nsvHost = (CustomNestedScrollView) host;
    ...
    public interface OnScrollChangeListener {
        void onScrollChange(CustomNestedScrollView var1, int var2, int var3, int var4, int var5);
    }
}
