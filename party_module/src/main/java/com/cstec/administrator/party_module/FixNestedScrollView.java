...
public class FixNestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    static final int ANIMATED_SCROLL_GAP = 250;
    static final float MAX_SCROLL_FACTOR = 0.5F;
    private static final String TAG = "FixNestedScrollView";
    ...
    private FixNestedScrollView.SavedState mSavedState;
    private static final FixNestedScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new FixNestedScrollView.AccessibilityDelegate();
    private static final int[] SCROLLVIEW_STYLEABLE = new int[]{16843130};
    private final NestedScrollingParentHelper mParentHelper;
    private final NestedScrollingChildHelper mChildHelper;
    private float mVerticalScrollFactor;
    private FixNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;

    public FixNestedScrollView(@NonNull Context context) {
        this(context, (AttributeSet) null);
    }

    public FixNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOnScrollChangeListener(@Nullable FixNestedScrollView.OnScrollChangeListener l) {
            ...
            if (heightMode != 0) {
                if (this.getChildCount() > 0) {
                    ...
                    if (childSize < parentSpace) {
                        ...
                        int childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(parentSpace, MeasureSpec.UNSPECIFIED);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (action == 2 && this.mIsBeingDragged) {
            ...
            int activePointerId;
            Log.e("result", "当前值" + String.valueOf(action & 255));
            switch (action & 255) {
                case 0:
...
//                        this.mIsBeingDragged = false;
                ...
                case 1:
                case 3:
                    Log.e("result", "最终3333" + mIsBeingDragged);
                    this.mIsBeingDragged = false;
                    this.mActivePointerId = -1;
                    this.recycleVelocityTracker();
                    ...
                    this.stopNestedScroll(0);
                    Log.e("result", "最终3" + mIsBeingDragged);
                    break;
                case 2:
                    ...
                    if (activePointerId != -1) {
                        ...
                        if (pointerIndex == -1) {
                            Log.e("FixNestedScrollView", "Invalid pointerId=" + activePointerId + " in onInterceptTouchEvent");
                        } else {
                    ...
                    Log.e("result", "最终2" + mIsBeingDragged);
                case 4:
                case 5:
                default:
                    break;
            ...
            Log.e("result", "最终" + mIsBeingDragged);
        ...
        switch (actionMasked) {
            ...
            case 2:
                ...
                if (activePointerIndex == -1) {
                    Log.e("FixNestedScrollView", "Invalid pointerId=" + this.mActivePointerId + " in onTouchEvent");
                } else {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof FixNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
        } else {
            FixNestedScrollView.SavedState ss = (FixNestedScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        FixNestedScrollView.SavedState ss = new FixNestedScrollView.SavedState(superState);
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            if (super.performAccessibilityAction(host, action, arguments)) {
                ...
                FixNestedScrollView nsvHost = (FixNestedScrollView) host;
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Creator<FixNestedScrollView.SavedState> CREATOR = new Creator<FixNestedScrollView.SavedState>() {
            public FixNestedScrollView.SavedState createFromParcel(Parcel in) {
                return new FixNestedScrollView.SavedState(in);
            }

            public FixNestedScrollView.SavedState[] newArray(int size) {
                return new FixNestedScrollView.SavedState[size];
            }
        };
    ...
    public interface OnScrollChangeListener {
        void onScrollChange(FixNestedScrollView var1, int var2, int var3, int var4, int var5);
    }
}
